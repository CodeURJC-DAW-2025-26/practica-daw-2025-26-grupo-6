                                ...
                                <form action={formAction} ref={formRef} method="post" className={`custom-login-form needs-validation ${wasValidated && "was-validated"}`} noValidate>
                                    <div className="form">
                                        <div className="form-field">
                                            ...
                                            <input type="email" disabled={isPending} defaultValue={state.email} className="form-control" name="email" id="email" placeholder="ejemplo@correo.com" required />
                                        ...
                                        <div className="form-field">
                                            ...
                                            <input type="password" disabled={isPending} defaultValue={state.password} className="form-control" name="password" id="password" placeholder="********" minLength={4} maxLength={20} required />
                                            <div className="invalid-feedback">
                                    ...
                                    <div className="d-flex flex-column flex-md-row justify-content-evenly mt-5 mb-4">
                                        <a href="/new" className="submit-btn" style={{ background: '#6c757d', marginTop: 0, justifyContent: 'center', display: 'flex', textDecoration: 'none' }}>
                                    ...
                                    <div className="text-center pt-4 border-top">
                                        ...
                                        <a href="/new/register" className="text-primary fw-bold text-decoration-none" style={{ fontSize: '1.1rem' }}>
                                            <i className="bi bi-person-plus me-1" /> Click aquí para crear una
                                        </a>
                                    </div>
                                </form>
                            </div>
